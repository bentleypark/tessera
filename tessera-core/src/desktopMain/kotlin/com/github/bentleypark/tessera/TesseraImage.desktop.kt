...
/**
 * Tessera - Compose-native tile-based image viewer (Desktop JVM)
 *
 * @param imageUrl URL or path to the image (http/https, file://, local path)
 ...
 * @param imageLoader Image loading strategy (default: DesktopImageLoader)
...
private fun createDesktopDecoderFactory(): (ImageSource) -> RegionDecoder {
    return { source -> DesktopRegionDecoder(source) }
}
